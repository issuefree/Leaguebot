    ...
    do
            spellDmg = {
                    ...
                    Annie = {
                            ...
                            EDmgM = 0,--"10*Elvl+10+.2*ap", --x each attack suffered
                    ...
                    Evelynn = {
                            ...
                            RDmgM = "(5*Rlvl+10+.01*ap)*tmhp/100",
                    },
                    Ezreal = {
                    ...
                    Katarina = {
                            QDmgM = "math.max((30*Qlvl+30+.45*ap)*stagedmg1,(15*Qlvl+.15*ap)*stagedmg2,(45*Qlvl+30+.6*ap)*stagedmg3)", --stage1:Dagger, Each subsequent hit deals 10% less damage. stage2:On-hit. stage3: Max damage
                    ...
                    Teemo = {
                            ...
                            EDmgM = "34*Elvl+.7*ap", --Hit+poison for 4 seconds (bonus)
                            RDmgM = "125*Rlvl+75+.8*ap",
                    },
                    Tristana = {
                    ...
                    Zed = {
                            ...
                            QDmgP = "math.max((35*Qlvl+40+bad)*stagedmg1,(28*Qlvl+32+.8*bad)*stagedmg2,(35*Qlvl+40+bad)*1.5*stagedmg3)",  --stage1:multiple shurikens deal 50% damage. stage2:Secondary Targets. stage3: Max damage
