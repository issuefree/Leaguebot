...
function ValidTarget(object, distance, enemyTeam)
    ...
    return object ~= nil and (object.team ~= myHero.team) == enemyTeam and object.visible and not object.dead and (enemyTeam == false or object.invulnerable == 0) and (distance == nil or GetDistance(object) <= distance)
end
